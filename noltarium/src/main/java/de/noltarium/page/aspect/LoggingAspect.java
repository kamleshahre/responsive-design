package de.noltarium.page.aspect;
...
public class LoggingAspect {
	...
	@Before("execution(* de.noltarium.page.controller..*.*(..))")
	...
	@After("execution(* de.noltarium.page.controller..*.*(..))")
	...
	private Logger getLoggerFromJoinPoint(JoinPoint joinPoint)
	{
		...
		LOGGER.error("Logger not found using aspect logger");
		return LOGGER;
	}
